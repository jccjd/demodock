...
async def main() -> None:
    ...
    async with sandbox:
        ...
        print("\nChecking iFlow CLI availability...")
        # Check if iFlow CLI is available (pre-installed in the new image)
        ...
        print("\nKeeping sandbox alive for 10 minutes to allow VNC access. Press Ctrl+C to exit sooner.")
        try:
